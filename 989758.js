! function(e) {
    ...
    window.MarketGidBaseBlockC989758 = function(e, t, n, o, a, s) {
        ...
        c.sourceName = "", this.templates = [], this.templateId = 0, c.setStyles = function(e) {
            ...
            c.fallbackMode ? c.fallbackMode && 0 == this.countLoadBlocks && (c.root.innerHTML = "", c.context.document.getElementById("M463376PreloadC989758") && (c.context.document.getElementById("M463376PreloadC989758").style.display = "none")) : c.context.document.getElementById("MarketGidPreloadC" + this.containerId) ? c.context.document.getElementById("MarketGidPreloadC" + this.containerId).style.display = "none" : c.context.document.getElementById("M463376PreloadC" + this.containerId) ? c.context.document.getElementById("M463376PreloadC" + this.containerId).style.display = "none" : c.context.document.getElementById("MarketGidPreloadN" + this.containerId) ? this.context.document.getElementById("MarketGidPreloadN" + this.containerId).style.display = "none" : c.context.document.getElementById("M463376PreloadN" + this.containerId) && (c.context.document.getElementById("M463376PreloadN" + this.containerId).style.display = "none")
            ...
            if (0 == c.fakeMode && c.processHooks("beforeLoadNewsHooks"), this.isArray(e)) {
                ...
                if (0 == c.fakeMode && void 0 !== c.servicerData.lib) {
                    ...
                    c.context._mgq = c.context._mgq || [], c.context._mgq.push(["_mgload", {
                        ...
                        rootElement: c.root
                    }]), -1 == c.root.className.indexOf("_mgw_989758") && (c.root.className += (0 == c.root.className.length ? "" : " ") + "_mgw_989758"), -1 == c.root.className.indexOf("_mgVideoBlock_989758") && (c.root.className += (0 == c.root.className.length ? "" : " ") + "_mgVideoBlock_989758");
            ...
            var e = this.context.document,
                ...
                r = "clientWidth",
                o = "scrollTop";
            return c.isAmp() ? void 0 !== t["intersectionRect989758_" + c.uniqId] ? {
                c: t["intersectionRect989758_" + c.uniqId].height,
                s: t["intersectionRect989758_" + c.uniqId].y
            } : {
                c: t.intersectionRect989758.height,
                s: t.intersectionRect989758.y
            } : t.innerWidth ? {
                c: t.innerHeight,
                s: t.pageYOffset
            } : e[i] && e[i][r] ? {
            ...
            if ("html" in e) {
                ...
                var o = "mgBanner_989758_" + this.page + "_" + this.iteration,
            ...
            if (c.isArray(e)) {
                ...
                for (var h = [
                        ...
                        [/\{\$source\}/g, s.source],
                        [/\{\$src\}/g, 'width="200" height="150" data-i="' + s.id + '" src="' + (n = s.other.i, (n && 0 === n.indexOf("//") ? c.webProtocol + n : n) + '" nopin="nopin"')],
            ...
            var n = e ? "fs/" : "",
                o = c.blocksAddress + n;
            if (o += "989758/" + c.page, t && (c.requestParams.rsh = "rsh=" + t, c.requestParams.initial_composite = "initial_composite=" + c.id), void 0 !== c.context.MGi && (c.requestParams.iso = "iso=" + c.context.MGi, c.requestParams.token = "token=2820bf0b4be8df6192d3af6f3f240393"), c.requestParams.pv = "pv=5", void 0 !== c.context["ampOptions989758_" + c.uniqId]) {
                try {
                    var a = JSON.parse(c.context["ampOptions989758_" + c.uniqId])
                } catch (e) {}
            ...
            i.push("url=" + encodeURIComponent(e)), i.push("uuid=" + c.servicerData.rid), i.push("hash=" + r), i.push("cid=989758"), i.push("gb_uid=57325626"), i.push("h2=" + c.servicerData.h2), i.push("type=" + c.doubleClickType), i.push("checkId=" + c.doubleClickCheckId), t && i.push("isOut=" + t), n.src = c.webProtocol + "//c.mgid.com/doubleclick?" + i.join("&")
    ...
    if (document.getElementById("MG_ID")) {
        var l = document.getElementById("MG_ID").innerHTML,
            d = parent.window.document.getElementById("MarketGidScriptRootC" + l) ? "MarketGidScriptRootC" + l : "M463376ScriptRootC" + l;
        parent.window.document.getElementById(d) && (o = !0)
    } else {
        d = document.getElementById("MarketGidScriptRootC989758") || document.getElementById("MarketGidScriptRootC989758") ? "MarketGidScriptRootC989758" : (document.getElementById("M463376ScriptRootC989758"), "M463376ScriptRootC989758");
        document.getElementById(d) && (o = !0, a = !0, s = !0)
    }(document.getElementById("MarketGidComposite989758") || document.getElementById("M463376Composite989758")) && (o = !0, a = !0);
    var u = void 0 !== window.uniqId ? window.uniqId : ("00000" + Math.round(1e5 * Math.random()).toString(16)).slice(-5);
    if (!o) {
        if (document.getElementById("MG_ID")) {
            l = document.getElementById("MG_ID").innerHTML, d = parent.window.document.getElementById("MarketGidScriptRootG" + l) ? "MarketGidScriptRootG" + l : "M463376ScriptRootG" + l;
            parent.window.document.getElementById(d) && (o = !0)
        } else {
            d = document.getElementById("MarketGidScriptRootG57325626") ? "MarketGidScriptRootG57325626" : "M463376ScriptRootG57325626";
            document.getElementById(d) && (o = !0, a = !0, s = !0)
        }(document.getElementById("MarketGid0") || document.getElementById("M463376Widget0")) && (o = !0, a = !0), c = !0
    }
    if (o) {
        var h;
        if (c)
            if (a)
                if (s) {
                    (g = document.createElement("div")).id = "MarketGid0", document.getElementById(d).appendChild(g), window.MarketGidInfC989758 = new MarketGidBaseBlockC989758(g.id, window, !1, 57325626, u, 11)
                } else {
                    d = document.getElementById("MarketGid0") ? "MarketGid0" : "M463376Widget0", m = document.getElementById("MarketGid0") ? "1" : "2";
                    document.getElementById(d).innerHTML = "", window.MarketGidInfC989758 = new window.MarketGidBaseBlockC989758(d, window, !0, 0, u, m)
                }
        else {
            l = document.getElementById("MG_ID").innerHTML;
            (g = parent.window.document.createElement("div")).id = "MarketGid0";
            d = parent.window.document.getElementById("MarketGidScriptRootG" + l) ? "MarketGidScriptRootG" + l : "M463376ScriptRootG" + l, m = parent.window.document.getElementById("MarketGidScriptRootG" + l) ? "6" : "8";
            parent.window.document.getElementById(d).appendChild(g), window.MarketGidInfC989758 = new window.MarketGidBaseBlockC989758(g.id, parent.window, !1, l, u, m)
        } else if (a)
            if (s) {
                v = "" != u ? "_" + u : "";
                var f = (document.getElementById("M463376}ScriptRootC989758") || document.getElementById("M463376ScriptRootC989758") || document.getElementById("MarketGidScriptRootC989758"), 989758);
                if (!window.document.getElementById("MarketGidComposite" + f) || !window.document.getElementById("M463376Composite" + f)) {
                    (g = window.document.createElement("div")).id = "MarketGidComposite" + f + v;
                    var p = window.document.getElementById("MarketGidScriptRootC" + f) ? "MarketGidScriptRootC" + f : "M463376ScriptRootC" + f;
                    window.document.getElementById(p).appendChild(g), window.document.getElementById(p).id = p + v
                }
                y = window.document.getElementById("MarketGidPreloadC" + f) ? "MarketGidPreloadC" + f : "M463376PreloadC" + f;
                window.document.getElementById(y) && (window.document.getElementById(y).id = y + v);
                var d = document.getElementById("MarketGidComposite" + f + v) ? "MarketGidComposite" + f + v : "M463376Composite" + f + v;
                window.MarketGidInfC989758 = new window.MarketGidBaseBlockC989758(d, window, !1, f + v, u, 11)
            } else {
                d = document.getElementById("MarketGidComposite989758") ? "MarketGidComposite989758" : "M463376Composite989758";
                var m = document.getElementById("MarketGidComposite989758") ? "3" : "4";
                document.getElementById(d).innerHTML = "", window.MarketGidInfC989758 = new window.MarketGidBaseBlockC989758(d, window, !1, 0, u, m)
            }
        else {
            var g, v = "_" + u,
                l = document.getElementById("MG_ID").innerHTML;
            (g = parent.window.document.createElement("div")).id = "MarketGidComposite989758" + v;
            var d = parent.window.document.getElementById("MarketGidScriptRootC" + l) ? "MarketGidScriptRootC" + l : "M463376ScriptRootC" + l,
                m = parent.window.document.getElementById("MarketGidScriptRootC" + l) ? "9" : "10";
            parent.window.document.getElementById(d).id = d + v;
            var y = parent.window.document.getElementById("MarketGidPreloadC" + l) ? "MarketGidPreloadC" + l : "M463376PreloadC" + l;
            parent.window.document.getElementById(y) && (parent.window.document.getElementById(y).id = y + v), d += v, parent.window.document.getElementById(d).appendChild(g), window.MarketGidInfC989758 = new window.MarketGidBaseBlockC989758(g.id, parent.window, !1, l + v, u, m)
        }
        n(2), window.MarketGidCMainBlock989758.call(window.MarketGidInfC989758, window.MarketGidInfC989758), window.MarketGidInfC989758.funcBlocks.Main = "MarketGidCMainBlock989758", n(3), window.MarketGidCSubnetsBlock989758.call(window.MarketGidInfC989758, window.MarketGidInfC989758), window.MarketGidInfC989758.funcBlocks.Subnets = "MarketGidCSubnetsBlock989758", n(4), window.MarketGidCAdvertLinkBlock989758.call(window.MarketGidInfC989758, window.MarketGidInfC989758), window.MarketGidInfC989758.funcBlocks.AdvertLink = "MarketGidCAdvertLinkBlock989758", n(5).call(window.MarketGidInfC989758, window.MarketGidInfC989758), n(6), window.MarketGidCInternalExchangeBlock989758.call(window.MarketGidInfC989758, window.MarketGidInfC989758), window.MarketGidInfC989758.funcBlocks.InternalExchange = "MarketGidCInternalExchangeBlock989758", n(7), window.MarketGidCColorBlock989758.call(window.MarketGidInfC989758, window.MarketGidInfC989758), window.MarketGidInfC989758.funcBlocks.Color = "MarketGidCColorBlock989758", n(8), window.MarketGidCUtilsBlock989758.call(window.MarketGidInfC989758, window.MarketGidInfC989758), window.MarketGidInfC989758.funcBlocks.Utils = "MarketGidCUtilsBlock989758", n(9), window.MarketGidCMonitorBlock989758.call(window.MarketGidInfC989758, window.MarketGidInfC989758), window.MarketGidInfC989758.funcBlocks.Monitor = "MarketGidCMonitorBlock989758", n(10), window.MarketGidCChangeColorBlock989758.call(window.MarketGidInfC989758, window.MarketGidInfC989758), window.MarketGidInfC989758.funcBlocks.ChangeColor = "MarketGidCChangeColorBlock989758", n(12), window.MarketGidCRejectBlock989758.call(window.MarketGidInfC989758, window.MarketGidInfC989758), window.MarketGidInfC989758.funcBlocks.Reject = "MarketGidCRejectBlock989758", n(13), window.MarketGidCCriteoBlock989758.call(window.MarketGidInfC989758, window.MarketGidInfC989758), window.MarketGidInfC989758.funcBlocks.Criteo = "MarketGidCCriteoBlock989758", n(14), window.MarketGidCAmpRenderBlock989758.call(window.MarketGidInfC989758, window.MarketGidInfC989758), window.MarketGidInfC989758.funcBlocks.AmpRender = "MarketGidCAmpRenderBlock989758", n(15), window.MarketGidCInternalExchangeLoggerBlock989758.call(window.MarketGidInfC989758, window.MarketGidInfC989758), window.MarketGidInfC989758.funcBlocks.InternalExchangeLogger = "MarketGidCInternalExchangeLoggerBlock989758", n(16), window.MarketGidCMgqBlock989758.call(window.MarketGidInfC989758, window.MarketGidInfC989758), window.MarketGidInfC989758.funcBlocks.Mgq = "MarketGidCMgqBlock989758", n(17), window.MarketGidCStylesheetsBlock989758.call(window.MarketGidInfC989758, window.MarketGidInfC989758), window.MarketGidInfC989758.funcBlocks.Stylesheets = "MarketGidCStylesheetsBlock989758", n(18), window.MarketGidCCookieBlock989758.call(window.MarketGidInfC989758, window.MarketGidInfC989758), window.MarketGidInfC989758.funcBlocks.Cookie = "MarketGidCCookieBlock989758", n(19), window.MarketGidCObserverBlock989758.call(window.MarketGidInfC989758, window.MarketGidInfC989758), window.MarketGidInfC989758.funcBlocks.Observer = "MarketGidCObserverBlock989758", n(20), window.MarketGidCSspDoubleClickBlock989758.call(window.MarketGidInfC989758, window.MarketGidInfC989758), window.MarketGidInfC989758.funcBlocks.SspDoubleClick = "MarketGidCSspDoubleClickBlock989758", n(21), window.MarketGidCSendDimensionsBlock989758.call(window.MarketGidInfC989758, window.MarketGidInfC989758), window.MarketGidInfC989758.funcBlocks.SendDimensions = "MarketGidCSendDimensionsBlock989758", n(22), window.MarketGidCAntifraudBlock989758.call(window.MarketGidInfC989758, window.MarketGidInfC989758), window.MarketGidInfC989758.funcBlocks.Antifraud = "MarketGidCAntifraudBlock989758", n(24), window.MarketGidCAntifraudStatisticsBlock989758.call(window.MarketGidInfC989758, window.MarketGidInfC989758), window.MarketGidInfC989758.funcBlocks.AntifraudStatistics = "MarketGidCAntifraudStatisticsBlock989758", n(26), window.MarketGidCRtbBlock989758.call(window.MarketGidInfC989758, window.MarketGidInfC989758), window.MarketGidInfC989758.funcBlocks.Rtb = "MarketGidCRtbBlock989758", n(27), window.MarketGidCDiscountBlock989758.call(window.MarketGidInfC989758, window.MarketGidInfC989758), window.MarketGidInfC989758.funcBlocks.Discount = "MarketGidCDiscountBlock989758", n(28), window.MarketGidCActivateDelayBlock989758.call(window.MarketGidInfC989758, window.MarketGidInfC989758), window.MarketGidInfC989758.funcBlocks.ActivateDelay = "MarketGidCActivateDelayBlock989758", n(29), window.MarketGidCIframeSizeChangerBlock989758.call(window.MarketGidInfC989758, window.MarketGidInfC989758), window.MarketGidInfC989758.funcBlocks.IframeSizeChanger = "MarketGidCIframeSizeChangerBlock989758", "".length > 0 && (n(30), window.MarketGidCAccidentalClicksBlock989758.call(window.MarketGidInfC989758, window.MarketGidInfC989758), window.MarketGidInfC989758.funcBlocks.AccidentalClicks = "MarketGidCAccidentalClicksBlock989758"), n(31), window.MarketGidCExternalCountersBlock989758.call(window.MarketGidInfC989758, window.MarketGidInfC989758), window.MarketGidInfC989758.funcBlocks.ExternalCounters = "MarketGidCExternalCountersBlock989758", n(32), window.MarketGidCYandexTurboBlock989758.call(window.MarketGidInfC989758, window.MarketGidInfC989758), window.MarketGidInfC989758.funcBlocks.YandexTurbo = "MarketGidCYandexTurboBlock989758", n(33), window.MarketGidCContentPreviewBlock989758.call(window.MarketGidInfC989758, window.MarketGidInfC989758), window.MarketGidInfC989758.funcBlocks.ContentPreview = "MarketGidCContentPreviewBlock989758", n(34), window.MarketGidCCountersBlock989758.call(window.MarketGidInfC989758, window.MarketGidInfC989758), window.MarketGidInfC989758.funcBlocks.Counters = "MarketGidCCountersBlock989758";
        var b = JSON.parse('{"blur":"auto","cols":"1","font":"roboto","kind":"wages","rows":"1","type":"in-article","media":{"opacity":80,"duration":1,"minWidth":250,"position":"bottom","minHeight":150,"videoOverlay":1},"mgbox":{"styles":{"maxWidth":1220}},"theme":"#2b397b","width":0,"button":1,"mcdesc":{"styles":{"font":"opensans","color":"#666666","display":"block","fontSize":11,"fontStyle":"normal","textAlign":"left","fontWeight":"normal","textDecoration":"none"}},"mgline":{"styles":{"borderColor":"#e9e9e9","borderStyle":"solid","borderWidth":1}},"imgType":"super","mcimage":{"size":200,"styles":{"padding":0,"borderColor":"#ffffff","borderStyle":"solid","borderWidth":0},"size-width":"200","size-height":"150"},"mcprice":{"show":"false","styles":{"font":"opensans","color":"#2a3a7b","fontSize":14,"fontStyle":"normal","textAlign":"left","fontWeight":"bold","textDecoration":"none"}},"mctable":{"styles":{"borderColor":"","borderWidth":0,"backgroundColor":""}},"mctitle":{"styles":{"color":"#474747","fontSize":16,"fontStyle":"normal","textAlign":"left","fontWeight":"bold","textDecoration":"none"}},"subType":"in-article-impact","mcdomain":{"styles":{"font":"roboto","color":"#868585","display":"block","fontSize":10,"fontStyle":"normal","textAlign":"left","fontWeight":"normal","textDecoration":"none"}},"isToaster":1,"colsMobile":1,"isDragDown":1,"colorButton":"","imageFormat":17,"imageShadow":"","textPosition":"right","autoplacement":"off","formatChanged":true,"customGradient":"","isInterstitial":0,"popupFrequency":15,"is_int_exchange":"0","showEffectButton":"false","showWidgetButton":"true","imageScaleOnHover":"","interstitialAfter":3,"sidebarWidthCorrect":0,"widgetTitleSettings":{"styles":{"font":"roboto","color":"#2b397b","fontSize":14,"text-transform":"uppercase"}},"frequencyCappingShow":3,"frequencyCappingTime":2,"sidebarScrollPercent":"0","widgetTypeDescription":1}');
        ("in-article" === b.type && "off" !== (null !== (h = b.autoplacement) && void 0 !== h ? h : "off") || ("in-article" === b.type && b.autoplacement, 0)) && (n(35), window.MarketGidCInArticleWidgetBlock989758.call(window.MarketGidInfC989758, window.MarketGidInfC989758), window.MarketGidInfC989758.funcBlocks.InArticleWidget = "MarketGidCInArticleWidgetBlock989758"); - 1 !== ["header-widget-carousel", "in-article-carousel"].indexOf("in-article-impact") && (n(37), window.MarketGidCCarouselWidgetBlock989758.call(window.MarketGidInfC989758, window.MarketGidInfC989758), window.MarketGidInfC989758.funcBlocks.CarouselWidget = "MarketGidCCarouselWidgetBlock989758"), window.MarketGidCGradientBlock989758 = function(e) {
        ...
        }, window.MarketGidCGradientBlock989758.call(window.MarketGidInfC989758, window.MarketGidInfC989758), window.MarketGidInfC989758.funcBlocks.Gradient = "MarketGidCGradientBlock989758";
        var k = !0;
        window.mg_loaded_463376_989758, 0, k && (window.MarketGidInfC989758.init(), void 0 === window.MarketGidInfC989758.context.MarketGidC989758DisableStart && (window.mg_loaded_463376_989758 = !0, window.MarketGidInfC989758.start()))
    }
}, function(e, t, i) {
    window.MarketGidCMainBlock989758 = function(e) {
    ...
    window.MarketGidCSubnetsBlock989758 = function(e) {
                            ...
                            if (e.originalId = e.id, e.id = t, e.loadedType = "goods", e.currentSubnet = i.id, e.currentSubnetDomain = i.mirror, e.originalId !== e.id && void 0 !== o[e.id] && void 0 !== o[e.id].customFuncBlocks) {
                                ...
                                for (var s in a)
                                    if (a.hasOwnProperty(s)) {
                                        var c = a[s];
                                        window["".concat("MarketGidC").concat(c, "Block").concat(989758)].call(window["".concat("MarketGidInfC989758")], window["".concat("MarketGidInfC989758")]), window["".concat("MarketGidInfC989758")].funcBlocks["".concat(c)] = "".concat("MarketGidC").concat(c, "Block").concat(989758)
                                    }
                            }
    ...
    window.MarketGidCAdvertLinkBlock989758 = function(e) {
        e.beforeLoadNewsHooks.push("refreshAdvertLink"), e.afterLoadNewsHooks.push("initAdvertPopup"), e.getAdvertLinkValue = function() {
            ...
            if (e.context.top === e.context.self && "banner" !== e.widgetConstructorData.type && "exit-pop-up" !== e.widgetConstructorData.type && -1 !== ["tablet", "desktop"].indexOf(e.deviceType) && void 0 === e.context._mgDisableAdvertPopup && n("MarketGidC") + "ConstructorBlock989758" != "function") {
            ...
            var n = (void 0 !== e.realRoot ? e.realRoot : e.root).parentNode,
                r = n.querySelector("._mgAdvertPopupC989758"),
    ...
    e.exports = function(e) {
        var t = null;
        e.log = function(i) {
            null === t && "1" == e.getQueryParameterByName("mgwdebug") && (t = !0), t && console.log("WIDGET_".concat(989758, "_").concat(e.uniqId), i)
        }
    }
}, function(e, t, i) {
    window.MarketGidCInternalExchangeBlock989758 = function(e) {
    ...
    window.MarketGidCColorBlock989758 = function(e) {
    ...
    window.MarketGidCUtilsBlock989758 = function(e) {
    ...
    window.MarketGidCMonitorBlock989758 = function(e) {
        this.afterLoadNewsHooks.push("monitorInit"), this.shownBlocks = {}, this.monitorTimeout = null, this.isFirstByType = {}, this.isFirstByCid = {}, this.monitorInit = function() {
            ...
            void 0 === a._mgPageImp463376 ? (a._mgPageImp463376 = !0, t += "&pageImp=1") : t += "&pageImp=0";
            try {
                if (e.context.localStorage) {
    ...
    window.MarketGidCChangeColorBlock989758 = function(e) {
    ...
    window.MarketGidCSmartDoubleClickBlock989758 = function(e) {
    ...
    window.MarketGidCRejectBlock989758 = function(e) {
                    ...
                    for (var n = i.getElementsByClassName("mcimg"), r = !1, o = 0; o < n.length; o++)
                        ...
                        if (null != s) {
                            ...
                            if (null != c && "i" != c[1] && 0 == a.length) {
                                ...
                                d.className = "close-informer", d.href = l + "/teaser/" + s[1] + "/widget/" + ("w" == c[1] ? "57325626/type/goods" : "0/type/news"), d.target = "_blank", d.rel = "nofollow", d.style.top = parseInt(u.borderTopWidth) + 3 + "px", d.style.right = parseInt(u.borderRightWidth) + 3 + "px", r.style.position = "relative", r.appendChild(d)
                            }
                        }
                    }
                }
    ...
    window.MarketGidCCriteoBlock989758 = function(e) {
    ...
    window.MarketGidCAmpRenderBlock989758 = function(e) {
        e.ampResized = [], e.ampRenderStart = function() {
            ...
            return void 0 !== e.context.context && void 0 !== e.context.context.data && void 0 !== e.context.context.data.widget || void 0 !== e.context.boundingClientRect989758 && void 0 !== e.context.intersectionRect989758
    ...
    window.MarketGidCInternalExchangeLoggerBlock989758 = function(e) {
    ...
    window.MarketGidCMgqBlock989758 = function(e) {
    ...
    window.MarketGidCStylesheetsBlock989758 = function(e) {
        e.stylesDom = {}, e.isIE = "undefined" == typeof Proxy, e.addStyle = function(t, i, n) {
            ...
            if (n) {
                var r = n;
                if (r.className = "MarketGidC989758", r.styleSheet) r.styleSheet.cssText = t;
                else {
                ...
                o.setAttribute("id", i), o.className = "MarketGidC989758", o.type = "text/css", (void 0 !== e.realRoot ? e.realRoot : e.root).appendChild(o), o.styleSheet ? o.styleSheet.cssText = t : o.appendChild(e.context.document.createTextNode(t))
            }
    ...
    window.MarketGidCCookieBlock989758 = function(e) {
        this.storageName = "MarketGidStorage" + (this.context.MarketGidPageOffset ? this.context.MarketGidPageOffset : ""), this.getCookieValue = function() {
            ...
            void 0 !== e.C989758 ? this.cookieStorage = e.C989758 : this.cookieStorage = {}, void 0 !== e[0] ? this.sharedCookieStorage = e[0] : this.sharedCookieStorage = {}
        }, this.setCookie = function() {
            var e = this.getCookieValue();
            e.C989758 = this.cookieStorage, e[0] = this.sharedCookieStorage;
    ...
    window.MarketGidCObserverBlock989758 = function(e) {
    ...
    window.MarketGidCSspDoubleClickBlock989758 = function(e) {
        ...
        e.doubleclickStyles = ".MarketGidDButton989758{display:       inline-block;", e.doubleclickStyles += 'width:         80px;height:        80px;background-color: RGBA(0,0,0,0.4);border:        2px solid white;border-radius:        999px;color:         white !important;font:          normal 500 24px/80px "Sans", sans-serif;transform: scale3d(0.0001,0.0001,0.0001);', e.doubleclickStyles += "text-align:    center;text-shadow:   none;position: absolute;text-decoration: none !important;transition:all 1s;}.MarketGidDLayout989758{height: 100%;width: 100% !important;position: absolute !important;top: 0px;left: 0px;background-color: rgba(0, 0, 0, 0.5);z-index: 99999;}#MarketGidComposite989758 .mgline {position:relative}", e.addStyle("ssp_doubleclick", e.doubleclickStyles), e.hashTimer = [], e.servicerDoubleClickStatus = !1, e.sspDoubleClickHook = function() {
            ...
            var n = t.getAttribute("data-hash"),
                r = (new Date).getTime();
            return n in e.hashTimer && r - e.hashTimer[n] > e.servicerData.dc || "w" !== e.teaserData[n].coopType || "MarketGidDButton989758" === t.className ? (e.doubleClickHandler(t, !0), !0) : (e.doubleClickHandler(t), i.preventDefault(), e.renderDoubleClick(t), !1)
    ...
    window.MarketGidCSendDimensionsBlock989758 = function(e) {
        e.afterPreRenderNewsHooks.push("calcPreRenderingBlock"), e.blankImage = "data:image/gif;base64,", e.precalcRect = {}, e.calcPreRenderingBlock = function() {
            setTimeout((function() {
                ...
                0 == n && (n = r.length), e.requestParams.cols = "cols=" + n, e.fakeMode = !1, e.root = e.realRoot, null !== e.root.querySelector("#preRenderingBlock989758_" + e.uniqId) && e.root.removeChild(e.root.querySelector("#preRenderingBlock989758_" + e.uniqId)), e.root.style.overflow = "visible", e.root.style.visibility = "visible", e.loadedType = "", e.currentSubnet = "", e.countLoadBlocks = e.countLoadBlocksContainer, e.template = "", e.iteration = 1, "function" == typeof e.widgetPreloadCallback && e.widgetPreloadCallback()
            }), 50)
            ...
            var i = e.context.document.createElement("div");
            i.id = "preRenderingBlock989758_" + e.uniqId, i.style.visibility = "hidden";
    ...
    window.MarketGidCAntifraudStatisticsBlock989758 = function(e) {
        var t = i(25),
            r = function() {
                function t() {
                    n(this, t)
    ...
    window.MarketGidCRtbBlock989758 = function(e) {
        this.afterLoadNewsHooks.push("cmPixelLoad"), this.cmPixelLoad = function(t) {
            if (!e.context["i.js.loaded"] && e.cookieMatchingDomain) {
                ...
                var i = window.MarketGidInfC989758.context.document.createElement("script");
                i.charset = "utf-8";
                ...
                }, (void 0 !== window.MarketGidInfC989758.realRoot ? window.MarketGidInfC989758.realRoot : window.MarketGidInfC989758.root).parentNode.appendChild(i)
            }
    ...
    window.MarketGidCDiscountBlock989758 = function(e) {
        this.afterLoadNewsHooks.push("discountsLoader"), this.discountMouseOver = function(t) {
            e.helpIE(this);
            var i = this.getElementsByClassName("mcpriceold57325626"),
                n = this.getElementsByClassName("mcprice57325626"),
                r = this.getElementsByClassName("mcdiscount57325626");
            ...
            e.helpIE(this);
            var i = this.getElementsByClassName("mcdiscount57325626"),
                n = this.getElementsByClassName("mcprice57325626"),
                r = this.getElementsByClassName("mcpriceold57325626");
            ...
            if (this.root) {
                ...
                var e, t = i(this.root.getElementsByClassName("mcteaser57325626"));
                try {
                    for (t.s(); !(e = t.n()).done;) {
                        var n = e.value;
    ...
    window.MarketGidCActivateDelayBlock989758 = function(e) {
        var t;
        e.clickableDelay = !1;
        var i = !1;
    ...
    window.MarketGidCIframeSizeChangerBlock989758 = function(e) {
    ...
    window.MarketGidCAccidentalClicksBlock989758 = function(e) {
        e.afterInitHooks.push("accidentalClicksLoad"), e.accidentalClicksDelay = 1e3 * (parseInt(e.globalSettings.accidental_clicks_delay) || 5), e.accidentalClicksDisableTypes = "".split(","), e.teasersClickTimes = {}, e.accidentalClicksHandler = function(t, i) {
    ...
    window.MarketGidCExternalCountersBlock989758 = function(e) {
    ...
    window.MarketGidCYandexTurboBlock989758 = function(e) {
        e.isTurbo = function() {
    ...
    window.MarketGidCContentPreviewBlock989758 = function(e) {
    ...
    window.MarketGidCCountersBlock989758 = function(e) {
        this.afterLoadNewsHooks.push("countersLoad"), this.countersLoad = function() {
            if (parseInt(e.id) !== parseInt(989758)) {
    ...
    var r = i(36);
    window.MarketGidCInArticleWidgetBlock989758 = function(e) {
    ...
    window.MarketGidCCarouselWidgetBlock989758 = function(e) {
